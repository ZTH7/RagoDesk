...
## 1. 背景与目标
企业希望快速搭建可控、可审计的客服机器人能力，并与现有系统对接（CRM/工单/门户）。RAGDesk 提供多租户、可配置的知识库与 RAG 能力，通过统一 API 对外提供对话服务，支持人工接入与统计分析。
