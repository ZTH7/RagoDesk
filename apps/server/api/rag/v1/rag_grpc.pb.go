...
const (
	RAG_SendMessage_FullMethodName = "/api.rag.v1.RAG/SendMessage"
)
...
func (c *rAGClient) SendMessage(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*SendMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendMessageResponse)
	err := c.cc.Invoke(ctx, RAG_SendMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRAGServer) SendMessage(context.Context, *SendMessageRequest) (*SendMessageResponse, error) {
...
func _RAG_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RAGServer).SendMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RAG_SendMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RAGServer).SendMessage(ctx, req.(*SendMessageRequest))
	}
...
var RAG_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.rag.v1.RAG",
	HandlerType: (*RAGServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendMessage",
			Handler:    _RAG_SendMessage_Handler,
		},
	},
